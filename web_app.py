"""MoonBite Web Dashboard — Flask application for blockchain visualization and interaction.

This module provides a RESTful API and web interface for MoonBite, allowing users to:
...
def api_wallet_balance():
    ...
    try:
        ...
        # For MoonBite: using simpler 100 satoshis = 1 coin for demo
