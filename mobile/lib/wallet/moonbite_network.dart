...
/// `moonbited` (validateaddress / importprivkey) on the respective network.
class MoonBiteNetwork {
  ...
  static final NetworkType _mainnetCoins = NetworkType(
    messagePrefix: 'MoonBite Signed Message:\n',
    bech32: 'big',
  ...
  static final MoonBiteNetwork mainnet = MoonBiteNetwork(
    id: 'mainnet',
    coins: _mainnetCoins,
    addressPrefixHint: 'big1…',
  );

  static final MoonBiteNetwork testnet = MoonBiteNetwork(
    id: 'testnet',
    coins: _testnetCoins,
    addressPrefixHint: 'tbig1…',
  );

  static final MoonBiteNetwork regtest = MoonBiteNetwork(
    id: 'regtest',
    coins: _regtestCoins,
    addressPrefixHint: 'big1…',
  );

  static MoonBiteNetwork byId(String id) {
    switch (id) {
      case 'testnet':
        return testnet;
      case 'regtest':
