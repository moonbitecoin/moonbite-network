...
void main() {
  ...
  test('selects multiple inputs when needed', () {
    final signed = builder.buildSpend(
      ...
      toAddress: acct1.bech32Address,
      amountSats: 250000000, // 2.5 MBITE => needs 3 inputs
      changeAddress: acct0.bech32Address,
      wif: acct0.wif,
      feeRateSatPerVByte: 1.0,
    );
  ...
  test('throws on insufficient funds', () {
    expect(
      () => builder.buildSpend(
        utxos: [utxo(0.5)],
        toAddress: acct1.bech32Address,
        amountSats: 100000000, // want 1 MBITE, only 0.5 available
        changeAddress: acct0.bech32Address,
        wif: acct0.wif,
        feeRateSatPerVByte: 1.0,
      ),
  ...
  test('drops dust change into the fee', () {
    ...
    // 1 MBITE utxo, send (1 MBITE - 150 sats): change would be ~ (150 - fee) < dust.
    final signed = builder.buildSpend(
      utxos: [utxo(1.0)],
      toAddress: acct1.bech32Address,
