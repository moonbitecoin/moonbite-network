...
|---|---|---|
| Website (GitHub Pages) | 🟢 Live | `zaptapagency.github.io/MoonBite` verified |
...
- [ ] A second machine syncs from the seed (`moonbite-cli addnode <ip>:9444 onetry`)
...
- [ ] Set `MOONBITE_RPC_USER`, `MOONBITE_RPC_PASSWORD`, `MINE=1`
...
- [ ] Vars: `MOONBITE_RPC_HOST=moonbite-node.railway.internal`, port 9445, same creds
- [ ] Vars: `MOONBITE_NAME=MoonBite`, `MOONBITE_TICKER=MBITE`
